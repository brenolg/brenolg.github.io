...
const allForOne = {
  ...
  img: sql,
  description: [
    "O objetivo deste projeto é praticar os conceitos de SQL, consolidar e aprimorar conhecimentos sobre a manipulação de bancos de dados, essenciais para o funcionamento de sistemas e empresas.",
  ],
  techs: [
    "Gerenciamento de dados",
    "Data Science",
...
const talkerManager = {
  img: talkerImg,
  description: [
    "Aplicação de palestrantes (talkers), na qual é possível cadastrar, listar, pesquisar, editar e excluir palestrantes. A API possui o conjunto de operações CRUD de palestrantes (talkers) e possui alguns endpoints que irão ler e escrever em um arquivo utilizando o módulo fs.",
  ],
...
const storeManager = {
  img: storeManagerImg,
  description: [
    "API de gerenciamento de vendas no modelo dropshipping, com arquitetura MSC e seguindo o REST. Utiliza o banco MySQL para criar, visualizar, atualizar e excluir produtos e vendas, garantindo integridade e escalabilidade.",
  ],
  techs: [
    "MSC Architeture",
    "Data Science",
...
const apiBlogs = {
  img: apiBlogsImg,
  description: [
    "API para um blog com CRUD de postagens e autenticação de usuários. Solução completa para produção de conteúdo, com a possibilidade de criar, editar, deletar e visualizar postagens, além de criar, editar e deletar usuários.",
  ],
  techs: [
    "MSC Architeture",
    "Javascript",
...
const commerce = {
  ...
  img: mongoDB,
  description: [
    "O projeto usa MongoDB para aplicar operadores e queries complexas em dados fictícios do cardápio do McDonalds, com alterações de documentos e expressões regulares.",
  ],
  techs: [
    "Gerenciamento de dados",
    "Data Science",
