...
const walletExpenses = {
  ...
  img: walletImg,
  description: [
    "Este projeto é uma carteira virtual que permite ao usuário gerenciar suas despesas e receitas em diferentes moedas. A aplicação computa gastos em diferentes moedas e converte tudo para uma única moeda.",
  ],
  techs: [
    "React",
    "Redux",
...
const tuneMusics = {
  ...
  img: tuneMusicsImg,
  description: [
    "Interface de streaming de música que permite ao usuário pesquisar por artistas e álbuns, adicionar músicas à sua playlist favorita e ouvir trechos das músicas disponíveis na API do iTunes.",
  ],
  techs: [
    "Lifecycle methods",
    "Javascript",
  ...
  functionalities: [
    ...
    "-Clicar em um card para ver mais detalhes do álbum",
...
const pixelArt = {
  ...
  functionalities: [
    ...
    "-Um botão que limpa o quadro preenchendo todos os pixels com branco",
  ],
...
const appReceitas = {
  ...
  img: appRecipesImg,
  description: [
    "Este é um projeto de app de receitas que consiste em desenvolver um sistema que permite visualizar, buscar, filtrar, favoritar, compartilhar e acompanhar o processo de preparação de receitas e drinks. A base de dados são de 2 APIs distintas.",
  ],
  techs: [
    "React",
    "LocalStorage",
  ...
  functionalities: [
    "-Buscar receitas",
    "-Acessar os detalhes de cada receita",
...
const toDoList = {
  ...
  img: toDoListImg,
  description: [
    "Aplicação web que permite ao usuário criar e gerenciar uma lista de tarefas (to-do-list). O usuário pode adicionar novas tarefas, marcar as tarefas concluídas, remover tarefas individuais ou todas as tarefas da lista..",
  ],
  techs: [
    "Dom manipulation",
    "LocalStorage",
...
const trivia = {
  ...
  img: triviaImg,
  description: [
    "Este projeto é um jogo de trivia que permite ao usuário testar seus conhecimentos em diferentes categorias e níveis de dificuldade. Projeto criado utilizando React e Redux , sendo desenvolvido em grupo onde as demandas definidas e organizadas em um quadro Kanban.",
  ],
